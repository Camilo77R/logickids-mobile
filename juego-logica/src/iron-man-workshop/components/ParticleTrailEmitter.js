...
export class ParticleTrailEmitter {
   ...
   __init2() {this.isEmitting = false}
   __init3() {this.emitPosition = new THREE.Vector3()}
   __init4() {this.emitDirection = new THREE.Vector3(0, -1, 0)}

  // Performance: Pre-allocated temp objects to avoid per-frame GC pressure
    __init5() {this._tempColor = new THREE.Color()}

  constructor(config = {}) {;ParticleTrailEmitter.prototype.__init.call(this);ParticleTrailEmitter.prototype.__init2.call(this);ParticleTrailEmitter.prototype.__init3.call(this);ParticleTrailEmitter.prototype.__init4.call(this);ParticleTrailEmitter.prototype.__init5.call(this);
   ...
   */
  startEmitting(position, direction, rate) {
  ...
  update(deltaTime) {
    ...
    if (this.isEmitting) {
      ...
      const rate = _nullishCoalesce(this.config.emissionRate, () => ( 4)); // Default to 4 (burst mode)
...
export class ParticleTrailSystem {
   __init6() {this.emitters = new Map()}
   __init7() {this.group = new THREE.Group()}

  constructor() {;ParticleTrailSystem.prototype.__init6.call(this);ParticleTrailSystem.prototype.__init7.call(this);
