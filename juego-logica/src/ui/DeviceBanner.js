...
export class DeviceBanner {
  ...
  // private autoHideTimeout: number | null = null; // Removed
   ...
   static  __initStatic() {this.STORAGE_KEY = 'gesture-lab-banner-dismissed-v4'}
   static  __initStatic2() {this.LAPTOP_MIN_WIDTH = 1024}

  

  constructor() {;DeviceBanner.prototype.__init.call(this);DeviceBanner.prototype.__init2.call(this);
  ...
  */
   ...
   createDOM() {
    ...
    requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        _optionalChain([this, 'access', _7 => _7.element, 'optionalAccess', _8 => _8.classList, 'access', _9 => _9.add, 'call', _10 => _10('device-banner--visible')]);
      });
    });
  }
...
} DeviceBanner.__initStatic(); DeviceBanner.__initStatic2();
