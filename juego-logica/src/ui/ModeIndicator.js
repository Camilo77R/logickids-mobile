...
export class ModeIndicator {
   ...
   __init2() {this.clickHandler = null}

  constructor(container) {;ModeIndicator.prototype.__init.call(this);ModeIndicator.prototype.__init2.call(this);
  ...
  update(
   ...
   createDOM() {
    ...
    const indicatorBox = this.element.querySelector('.mode-indicator-box') ;
